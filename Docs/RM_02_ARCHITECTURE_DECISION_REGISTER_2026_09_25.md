...
**Date:** 2026-09-25
**Status:** PC-01, AD-01 AND AD-02 PRODUCT DECISIONS RECORDED; AD-03 BOUNDED FIRST-ZONE DESIGN FOUNDER APPROVED (2026-09-25); AD-04–AD-07 PENDING; PC-01 APPROVED CHARTER INCORPORATION PENDING.
...
**Decision status:** **FOUNDER APPROVED / RECORDED — APPROVED PORTFOLIO BASELINE UPDATE PENDING.** PC-01 is no longer a founder-choice question. AD-01 Option B and AD-02 product scope are now founder-directed/recorded; AD-03 bounded one-server/one-zone/two-client design is founder approved; AD-04–AD-07, build and runtime gates remain pending. PC-01 does not authorize game implementation, production login, a paid build host, GitHub Actions or a merge to `main`.
...
**Decision artifact:** [AD-03 dedicated-server and first dev-zone boundary](https://github.com/node63labs/morabezza-game/blob/review/rm-02-architecture-decision-docket-20260925/Docs/AD_03_DEDICATED_SERVER_AND_FIRST_DEV_ZONE_DECISION_2026_09_25.md). It records the founder-approved bounded one-server/one-zone/two-client design; the approval does not extend to a particular hosting provider, cost, service capacity, production architecture, implementation or merge.

**Status:** FOUNDER APPROVED — BOUNDED AD-03 DESIGN; HOST, MAP, AUTH, ENGINE BUILD AND TWO-CLIENT RUNTIME BLOCKED OR NOT VERIFIED.
...
3. Apply the founder-approved AD-03 single-server zone direction and resolve AD-05 for **S0-W2 character/session identity and single-zone admission**. S0-W1a/b/c already contain draft dev-contact server RPC and HUD changes; do not duplicate that work or call it authenticated admission.
...
**PC-01, AD-01 and AD-02 product decisions and AD-03 bounded architecture design are founder recorded/approved. PC-01 charter incorporation, AD-04–AD-07, historical documentation migration and implementation-specific acceptance remain PENDING.**
